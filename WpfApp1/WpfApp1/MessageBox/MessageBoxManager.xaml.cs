...
namespace WpfApp1.MessageBox
{
    ...
    public partial class MessageBoxManager : INotifyPropertyChanged
    {
        ...
        private void ShowMessageBox(MessageBoxViewModel messageBoxViewModel)
        {
            ...
            var brushResource = messageBoxViewModel.MessageBoxType switch
            {
                MessageBoxTypes.Waiting => TryFindResource("WaitingMessageBackground"),
                MessageBoxTypes.TextMessage => TryFindResource("TextMessageBackground"),
                MessageBoxTypes.Customize => TryFindResource("CustomizeBackground"),
                MessageBoxTypes.CustomizeWithButton => TryFindResource("CustomizeWithButtonBackground"),
                _ => DefaultBackground
            };
        ...
        )
        {
            ...
            try
            {
                ...
                translationStoryboard.Completed += (_, _) =>
                {
                    //todo 这里应该删除动画
